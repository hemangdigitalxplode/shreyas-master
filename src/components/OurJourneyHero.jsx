...
import heroImage from '../assets/images/our-journey.jpg';


const OurJourneyHero = () => {
    ...
    const heroSlides = [
        {
            id: 1,
            image: heroImage,
            titleBold: "Be a Part of Our<br/>Growth Journey",
            desc:
                "At Shreyas Sortex Group, we don't just process grain; we cultivate talent and fuel global progress.",
            stats: [
