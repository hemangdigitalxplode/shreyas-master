    ...
    <section className="plastic-section">
      <div className="plastic-container">
        ...
        <div className="plastic-left">
          ...
          <p>
            Preserving our most vital resource. Our internal water recycling plants, integrated within every Shreyas Group, ensure that water is treated, purified, and reused across all business verticals.
          </p>
          ...
          <div className="plastic-cards">
            ...
            <div className="plastic-row">
              ...
              <div className="content-box">
                <span className="card-title">ZLD</span>
                <span className="card-sub">Zero Liquid Discharge</span>
              </div>
            </div>
