    ...
    const heroSlides = [
        {
            id: 1,
            image: heroImage,
            titleBold: "Our Food Grains<br />Range",
            desc: "Premium quality grains sourced directly from the finest farms, processed with precision",
            ctaBtn: "Download Corporate Profile"
        }
    ];
    return (
        <>
