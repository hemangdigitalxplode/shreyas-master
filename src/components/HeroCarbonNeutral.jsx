...
import heroImage from '../assets/images/hero-banner-carbon.png';

const HeroCarbonNeutral = () => {
    ...
    const heroSlides = [
        {
            id: 1,
            image: heroImage,
            titleBold: "Powering a Carbon<br/>Neutral Future",
            desc:
                "Decarbonizing the industrial landscape through advanced Bio-energy, Solar integration, and High-Efficiency Cogeneration.",
            stats: [
...
export default HeroCarbonNeutral