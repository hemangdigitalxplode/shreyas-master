...
import heroImage from '../assets/images/banner-feeding.jpg';

const FeedingWorldHero = () => {
    ...
    const heroSlides = [
        {
            id: 1,
            image: heroImage,
            titleBold: "Feeding the World<br/>with Precision",
            desc:
                "From the heart of India to the tables of over 50+ countries, Shreyas Group ensures seamless global distribution of premium quality rice.",
            stats: [
...
export default FeedingWorldHero